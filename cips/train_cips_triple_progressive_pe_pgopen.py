...
def train(args, loader, loader2, loader3, generator, discriminator, g_optim, d_optim, g_ema, g_ema_temp, g_ema_temp2, device, fid_dataset, fid_dataset2, fid_dataset3, n_scales, writer, path):
    ...
    for p2iter in range(args.iter):
        ...
        g_module.progressive_open_pe_activation_mask(unmasking_ratio=args.unmasking_ratio2, previous_unmasking_ratio=args.unmasking_ratio1, total_iteration=args.pgopen_iter, current_iteration=p2iter, device=device)
        g_ema_temp2.progressive_open_pe_activation_mask(unmasking_ratio=args.unmasking_ratio2, previous_unmasking_ratio=args.unmasking_ratio1, total_iteration=args.pgopen_iter, current_iteration=p2iter, device=device)
    ...
    for idx in pbar:
        ...
        g_module.progressive_open_pe_activation_mask(unmasking_ratio=args.unmasking_ratio3, previous_unmasking_ratio=args.unmasking_ratio2, total_iteration=args.pgopen_iter, current_iteration=i, device=device)
        g_module.progressive_open_pe_activation_mask(unmasking_ratio=args.unmasking_ratio3, previous_unmasking_ratio=args.unmasking_ratio2, total_iteration=args.pgopen_iter, current_iteration=i, device=device)
