...
def train(args, loader, loader2, loader3, generator, discriminator, g_optim, d_optim, g_ema, g_ema_temp, g_ema_temp2, device, fid_dataset, fid_dataset2, fid_dataset3, n_scales, writer, path):
    ...
    g_ema_temp2.update_pe_mask(unmasking_ratio=args.unmasking_ratio2, device=device)
    ...
    g_module.update_pe_mask(unmasking_ratio=args.unmasking_ratio3, device=device)
    g_ema.update_pe_mask(unmasking_ratio=args.unmasking_ratio3, device=device)
