...
def ddp_worker(rank, world_size, args):
    ...
    dataset_2x = MultiScaleMipDataset(args.path_2x, transform=transform, resolution=int(args.coords_size/args.patch_multiplier)*2, crop_size=int(args.crop/args.patch_multiplier)*2,
                                integer_values=args.coords_integer_values, to_crop=args.to_crop)
